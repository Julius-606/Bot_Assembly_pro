...
# 🔐 LOAD SECRETS (ENV)
# ------------------------------------------------------------------------------
# Explicitly load the .env file located next to this config file (Nexus/.env)
...
try:
    ...
    if _dbg:
        print(f"   🧭 Nexus config: loaded .env from {dotenv_path} -> MT5_LOGIN={_dbg}")
except Exception:
    pass
...
WORKSHEET_COACH = "Coach Nexus"
DRIVE_FOLDER_ID = "16ZJgg2S6NriT84AStjhvM9UI3ckp4rEM"
MEMORY_FILENAME = "nexus_memory.json"
