...
from config import (
    ...
    DEFAULT_STRATEGY, MEMORY_FILENAME
)
    ...
    def log_trade(self, trade, reason="OPEN"):
        ...
        try:
            ...
            try: ws = sheet.worksheet(WORKSHEET_LOGS)
                ...
                # Removed "Log Time" from headers per user request
            ...
            # log_time = datetime.now().strftime("%Y-%m-%d %H:%M:%S") # 🗑️ Removed redundant timestamp
